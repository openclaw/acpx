...
- ACP/stdio: fail closed when an incomplete NDJSON line exceeds 8 MiB so a peer that never sends a newline cannot grow the host buffer without bound. Thanks @SebTardif.
