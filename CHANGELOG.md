...
- Flows: keep a positive kill deadline for shell actions when timeoutMs is 0 or negative so a non-exiting command cannot disable SIGTERM/SIGKILL. Thanks @SebTardif.
